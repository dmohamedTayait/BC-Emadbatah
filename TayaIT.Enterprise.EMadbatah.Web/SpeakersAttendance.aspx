                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="<span class='space-st1' style='color:blue'>حاضر</span><span class='space-st1' style='color:red'>غائب</span><span class='space-st1' style='color:green'>غائب بعذر</span>">
                             ...
                             <asp:TemplateField HeaderText="">
                                <ItemTemplate>
                                    <asp:TextBox runat="server" ID="txtAbsenceExcuse" Text='' style="display:none;width:250PX"></asp:TextBox></ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblJobTitle" Text='<%#  Eval("JobTitle")%>'></asp:Label></ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
